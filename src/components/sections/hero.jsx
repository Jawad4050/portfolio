                    ...
                    <div className="col-lg-4">
                        <SlideUp>
                            <div className="about-image-part">
                                <img className='mb-3 rounded-4' src={"/images/user-img.png"} alt="About Me" />
                                <h2 className='mt-4'>Jawad Shahid</h2>
                    ...
                    <div className="col-lg-8">
                        <SlideUp>
                            <div className="about-content-part">
                                <p>Hello There!</p>
                                <h2>
                                I’m Jawad Shahid, a front-end developer bringing ideas to life with clean code and intuitive user interfaces.
                                </h2>
